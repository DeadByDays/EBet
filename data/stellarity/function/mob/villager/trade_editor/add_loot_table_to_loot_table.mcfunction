$data modify storage stellarity:temp villager_trades append value {xp:$(xp),maxUses:$(max_uses),rewardExp:1b,priceMultiplier:$(price_multiplier),buy:{id:"minecraft:stone",count:$(buy_a_count)},buyB:{id:"minecraft:amethyst_shard",count:$(buy_b_count),components:{"minecraft:custom_data":{stellarity.special_item:"enderite_shard"},"minecraft:item_model":"stellarity:enderite_shard","minecraft:item_name":'{"translate":"stellarity.items.materials.enderite_shard"}',"minecraft:lore":['""','{"color":"#EEEEEE","italic":false,"translate":"stellarity.items.materials.enderite_shard.description"}','""','{"color":"#CC26FF","italic":true,"translate":"Stellarity"}'],"minecraft:rarity":"uncommon"}},sell:{id:"minecraft:stone",count:$(sell_count)}}
